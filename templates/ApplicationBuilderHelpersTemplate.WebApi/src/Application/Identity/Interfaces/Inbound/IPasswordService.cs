namespace Application.Identity.Interfaces.Inbound;
...
public interface IPasswordService
{
    ...
    /// <summary>
    /// Initiates the forgot password flow: generates a reset token, builds a reset link, and sends the email.
    /// Always completes without error regardless of whether the email exists (for security).
    /// </summary>
    /// <param name="email">The user's email address.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
