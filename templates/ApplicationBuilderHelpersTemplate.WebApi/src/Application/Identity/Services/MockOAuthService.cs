    ...
    IUserRegistrationService registrationService) : IOAuthService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var existingUserId = await userRepository.FindUserByLoginAsync(
            userInfo.Provider,
        ...
        {
            var existingUser = await userRepository.FindByIdAsync(existingUserId.Value, cancellationToken);
        ...
        {
            var userByEmail = await userRepository.FindByEmailAsync(userInfo.Email, cancellationToken);
        ...
        var newUser = await registrationService.RegisterExternalAsync(registrationRequest, cancellationToken);
