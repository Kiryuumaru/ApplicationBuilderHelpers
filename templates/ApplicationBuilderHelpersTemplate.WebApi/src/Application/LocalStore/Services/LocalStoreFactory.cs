...
{
    public async Task<IConcurrentLocalStore> OpenStoreAsync(string group = "common_group", CancellationToken cancellationToken = default)
    {
        ...
        await localStoreService.OpenAsync(cancellationToken);
