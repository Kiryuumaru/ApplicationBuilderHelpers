...
{
    /// <summary>
    /// The identifier used for read-scope permissions.
    /// </summary>
    public const string ReadScopeIdentifier = "_read";

    /// <summary>
    /// The identifier used for write-scope permissions.
    /// </summary>
    public const string WriteScopeIdentifier = "_write";
    ...
    static Permissions()
    {
        RootReadPermission = CreateRootScope(ReadScopeIdentifier, "Read access to all platform operations.", PermissionAccessCategory.Read);
        RootWritePermission = CreateRootScope(WriteScopeIdentifier, "Write access to all platform operations.", PermissionAccessCategory.Write);
    ...
    private static Permission ReadScope(string scopeLabel) =>
        Scope(ReadScopeIdentifier, $"Read access to {scopeLabel}.", PermissionAccessCategory.Read);

    private static Permission WriteScope(string scopeLabel) =>
        Scope(WriteScopeIdentifier, $"Write access to {scopeLabel}.", PermissionAccessCategory.Write);
