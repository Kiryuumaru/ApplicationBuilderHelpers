...
public static class ScopeEvaluator
{
    ...
    private static bool PathMatches(string directivePath, string requestedPath)
    {
        ...
        if (string.Equals(directivePath, Permissions.ReadScopeIdentifier, StringComparison.Ordinal))
        {
        ...
        if (string.Equals(directivePath, Permissions.WriteScopeIdentifier, StringComparison.Ordinal))
        {
