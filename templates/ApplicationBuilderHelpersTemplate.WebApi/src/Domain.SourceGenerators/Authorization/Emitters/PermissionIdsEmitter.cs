...
internal static class PermissionIdsEmitter
{
    ...
    private static void WriteGlobalScopes(StringBuilder builder)
    {
        ...
        builder.AppendLine();
        builder.AppendLine("        /// <summary>Template parameter 'userId' used when scoping this permission.</summary>");
        builder.AppendLine("        public const string UserIdParameter = \"userId\";");
        builder.AppendLine();
        ...
        builder.AppendLine();
        WriteScopeBuilderStruct(builder, indentLevel: 2, parameters: ImmutableArray.Create("userId"), useWithPrefix: true);
        builder.AppendLine("    }");
        builder.AppendLine();
    ...
    private static void WriteScopeLeaf(StringBuilder builder, int indentLevel, string identifier, ImmutableArray<string> combinedParameters)
    {
        ...
        if (combinedParameters.Length > 0)
        {
            ...
            foreach (var parameter in combinedParameters)
            {
                ...
                builder.Append(IdentifierNaming.ToParameterIdentifier(parameter));
