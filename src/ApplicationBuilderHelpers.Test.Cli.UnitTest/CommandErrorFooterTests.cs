...
public sealed class CommandErrorFooterTests
{
    ...
    [InlineData(CommandErrorKind.UnknownOption, null, "Run 'test <command> --help' for more information on specific command options.")]
    [InlineData(CommandErrorKind.UnknownOption, "config", "Run 'test <command> --help' for more information on specific command options.")]
    [InlineData(CommandErrorKind.MissingRequired, null, "Run 'test <command> --help' for more information on specific command options.")]
    [InlineData(CommandErrorKind.MissingRequired, "config", "Run 'test <command> --help' for more information on specific command options.")]
    [InlineData(CommandErrorKind.UnknownCommand, null, "Run 'test <command> --help' for more information on specific command options.")]
    [InlineData(CommandErrorKind.UnknownCommand, "config", "Run 'test <command> --help' for more information on specific command options.")]
    ...
    [InlineData(CommandErrorKind.InvalidValue, "config", "Run 'test --help' for more information on available commands and options.")]
    [InlineData(CommandErrorKind.DuplicateOption, null, "Run 'test --help' for more information on available commands and options.")]
    [InlineData(CommandErrorKind.DuplicateOption, "config", "Run 'test --help' for more information on available commands and options.")]
